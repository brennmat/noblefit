...
for i = 1:Nsmpl % fit each sample
    ...
    if DF(i) < 0 % there is no point in trying to fit anything
        ...
        warnstate_bounds   = warning ('query','noblefit:modelfun_params_out_of_bounds');   warning ('off','noblefit:modelfun_params_out_of_bounds');
        ...
        warning (warnstate_bounds.state,'noblefit:modelfun_params_out_of_bounds');
